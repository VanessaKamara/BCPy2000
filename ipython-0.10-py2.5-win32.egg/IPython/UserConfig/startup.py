...
#    execute __IPYTHON__.rc.editor = 'uedit32'  # (or whatever other editor is present on each particular system)
# above the line that executes this file in ipythonrc.ini, or alternatively just
#    editor uedit32
...
"""###
		...
		pth = [x for x in pth if os.path.isfile(x)][0]
...
"""###
		...
		def magic_pp(name=''):
			if name == None: return
			exec 'import SigTools; print SigTools.summarize(' + name + ')' in ipython
